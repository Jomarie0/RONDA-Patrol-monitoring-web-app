...
ALLOWED_HOSTS = [h.strip() for h in os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,192.168.1.26').split(',') if h.strip()]
...
# PostgreSQL for production (set DJANGO_DB=postgres to use):
# DATABASES['default'] = {
